...
class Packagedd extends Component
{
    use WithPagination;
    ...
    public $ventanilla = '';
    public $ciudad = '';
    public $diasEntrega = ''; // Nueva propiedad para los días
    ...
    public function getFilteredPackages()
    {
        $response = Http::withHeaders([
            ...
            'verify' => false,
        ])->get('http://correos.gob.bo:8000/api/softdeletesUDD');
    ...
    public function render()
    {
        ...
        return view('livewire.packagedd', [
