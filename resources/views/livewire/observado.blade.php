<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="d-flex justify-content-center">
                            Se encontraron {{ $observados->total() }} registros en total
                        </div>
                        <table class="table table-striped table-hover">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th>Fecha observado</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($observados as $observado)
                                    <tr>
                                        <td>{{ $observado['identificador'] }}</td>
                                        <td>{{ $observado['oforigen'] }}</td>
                                        <td>{{ $observado['ofdestino'] }}</td>
                                        <td>{{ $observado['peso_total'] }} kg</td>
                                        <td>{{ $observado['paquetes_total'] }}</td>
                                        <td>{{ $observado['created_at'] }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
            ...
            <div class="d-flex justify-content-center">
                {{ $observados->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
</div>
