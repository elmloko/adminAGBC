<div>
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla DND del Área Clasificacion</h3>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla DND del Área Ventanilla</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Paquetes en Ventanilla DND por Día</h3>
                            <h5 class="box-title">Inventario desde 01/2024</h5>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="info-box bg-success">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Paquetes en Ventanilla DND</span>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla DND del Área Carteros</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Paquetes CARTERO vs RETORNADOS por dia</h3>
                            <h5 class="box-title">Inventario desde 01/2024</h5>
                        </div>
                        <div class="box-body">
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla DND ENTREGADOS</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                new Chart(ctxDay, {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Cantidad de Paquetes DND por Día'
                            }
                        }
                    }
                });
                ...
                new Chart(ctxVentanillaDay, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Paquetes en Ventanilla DND por Día',
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Paquetes en Ventanilla DND por Día'
                            }
                        }
                    }
                });
