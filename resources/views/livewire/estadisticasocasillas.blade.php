<div>
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla CASILLAS del Área Clasificacion</h3>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla CASILLAS del Área Ventanilla</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="info-box bg-success">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Paquetes en Ventanilla CASILLAS</span>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla CASILLAS del Área Carteros</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">Estadísticas de Paquetes Ordinarios para Ventanilla CASILLAS ENTREGADOS</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                </button>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                new Chart(ctxDay, {
                    ...
                    data: {
                        labels: labelsDay,
                        datasets: [{
                            label: 'Paquetes CASILLAS por Día',
                            data: dataDay,
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Cantidad de Paquetes CASILLAS por Día'
                            }
                        }
                    }
                });
                ...
                new Chart(ctxVentanillaDay, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Paquetes en Ventanilla CASILLAS por Día',
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Paquetes en Ventanilla CASILLAS por Día'
                            }
                        }
                    }
                });
